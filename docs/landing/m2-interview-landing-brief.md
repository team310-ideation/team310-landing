...
```yaml
h1: "학부모·학생 인터뷰 모집"
subheading: "아이 생기부, 예비고1 준비, 담임 상담 질문이 막막하다면 30분만 들려주세요."
support: "Team 310은 AI·SW마에스트로 17기 프로젝트 팀으로, 입시 정보보다 우리 아이 기록 기준의 우선순위가 필요한 문제를 검증하고 있습니다."
primary_cta: "30분 인터뷰 신청하기"
...
members:
  - name: "박세종"
    ...
    proof:
      - "국제캠프 PM, 550명+·18개국 운영"
      - "입시 데이터 3만 건 분석"
      - "진로코칭 및 교육 서비스 사용자 검증 경험"
  - name: "박준혁"
...
trust_items:
  - title: "정부 지원 프로젝트"
    copy: "AI·SW마에스트로 17기 선발 과정 통과 후 기획심의를 준비 중인 팀이다."
  - title: "실명 담당자"
    copy: "인터뷰 문의는 Team Lead 박세종이 직접 받는다."
    contact: "lifedesigner88@gmail.com"
  - title: "개인정보 원칙"
...
typography:
  ...
  hero_h1: "32px mobile / 48-52px desktop"
...
```yaml
og_title: "학부모·학생 30분 인터뷰 모집 | Team 310"
og_description: "생기부·예비고1·담임상담 준비가 막막한 학부모님의 이야기를 듣습니다. 자료 업로드 없이 가능, 문화상품권 제공."
naver_first_paragraph: "Team 310은 AI·SW마에스트로 17기 프로젝트 팀으로, 중3·예비고1 학부모와 학생의 입시·진로 고민을 듣는 30분 인터뷰를 진행합니다."
sharing_context:
  - "카카오톡"
  - "네이버 검색"
  - "네이버 카페/블로그"
